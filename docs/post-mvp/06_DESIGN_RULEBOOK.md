...
| R03 | Due colonne sono la base per le liste di persone dense. Ogni card mantiene nome e controlli chiaramente associati; un caso eccezionale con più azioni può estendersi sulle due colonne. Terza colonna solo con beneficio misurato. | Nomi lunghi, omonimi, minorenni, persona selezionata e disabilitata; stessa sequenza di lettura e nessuna ambiguità fra card e controllo.  |
...
| Valutazioni                      | Cinque valori direttamente selezionabili | Nome e valori sulla stessa riga; il nome apre la nota; nessun controllo separato per “assenza”. |
...
- Nome e cinque valutazioni condividono una riga; il nome è anche l'accesso esplicito alla nota. Le valutazioni usano vere icone vettoriali per tutti i cinque segni. I doppi segni condividono asse e spaziatura; non affidarsi all'allineamento tipografico dei caratteri base.
