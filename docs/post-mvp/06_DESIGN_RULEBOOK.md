...
**Stato:** aggiornato alle revisioni umane fino al 6 settembre 2026; geometria r7 da valutare nei mock. Da usare con [05](../../05_POST_MVP_UX_CHANGE_REQUESTS.md), [07](07_PAGE_CHANGELOG.md) e [12](12_R2_REVIEW_QUESTIONS.md). I valori di progetto sotto non sono già un mock complessivamente approvato.
...
| R03 | Due colonne sono una prima ipotesi per liste semplici. Quando nome e più controlli appartengono alla stessa persona, usare una riga intera se preserva meglio associazione e leggibilità; terza colonna solo con beneficio misurato. | Nomi lunghi, omonimi, minorenni, persona selezionata e disabilitata; stessa sequenza di lettura e nessuna ambiguità fra riga e controllo.  |
...
La [galleria r7](mockups/index.html) ritaglia soltanto la scritta dell'asset CVC e conserva il simbolo intero. Usa una ricostruzione grafica del logo RS Quest fornito dall'autore perché l'immagine originale era già tagliata sul lato destro; l'asset originale resta conservato. Propone tre accenti arancioni e tre blu sulla Home, un blu funzionale con superfici chiare e indicatori sticky soltanto quando devono restare visibili durante lo scroll. Il nome CVC Helper e la scelta finale del font restano da discutere. Immagini Instagram come sfondi o card sono un possibile upgrade futuro, non parte del target r7.

### Regole aggiunte dalle revisioni r2–r7
...
- La modifica di una Comandata è centrata sul giorno scelto in P11 e si apre senza popup intermedio. Ordine: assegnati correnti, mai assegnati, assegnati altrove. Ogni allievo usa una riga a tutta larghezza: nome, giorni abbreviati Lun–Dom e rimozioni restano sullo stesso asse. Il bottone nome si riconosce dalla superficie, senza ripetere “Assegna a…”. Il nome completo del giorno resta disponibile nel titolo e nelle etichette accessibili.
...
- Le valutazioni usano vere icone vettoriali per tutti i cinque segni. I doppi segni condividono asse e spaziatura; non affidarsi all'allineamento tipografico dei caratteri base.
- La stessa griglia settimanale va riusata in P04, P18 e P19, con dati e semantica coerenti e senza scroll orizzontale.
- In P18 una piccola etichetta nomina l'ordinamento; la riduzione visiva dei bottoni e della riga nome conserva il target minimo del progetto.
