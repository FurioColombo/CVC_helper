...
- Le tre figure sono disegnate, non prese dal set: nessun set di icone ha teste con genere, e i simboli di Marte e Venere provati per primi si leggono come simboli, non come persone. Uomo e Donna sono piene — a 18 px un contorno da 2 px perde proprio i capelli, che sono l'unica differenza leggibile — e i capelli della figura femminile sono larghi una volta e mezzo la testa. Altro resta la figura a contorno già in uso: le tre si distinguono per sagoma **e** per peso, non per un'acconciatura.
