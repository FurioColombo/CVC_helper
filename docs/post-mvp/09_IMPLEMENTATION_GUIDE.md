...
3. Rivedere i target r8 di P13/P17, i target r7 di P04/P14/P16 e il fix P18; P19 è approvata, mentre P15 è approvata nella struttura visiva e conserva l'interazione r6 da validare.
...
| U10 | RULE_HEAVY       | P11 → P12 → P13, Comandate                                                         | Copertura assegnati/totale, card top-aligned, `floor`+resto, apertura diretta sul giorno, due allievi per riga con giorni brevi e azioni associate, casi multi-giorno integri, icona warning vettoriale, completati e manual override; reviewer avversariale.                                            |
