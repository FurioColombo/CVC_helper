...
1. Applicare le decisioni umane consolidate fino al 6 settembre in `08` e `12`. Q01–Q13 sono risolte o superate per il design; restano nome/logo finale e tempi voce da misurare.
2. Approvare regole comuni e perimetro del ciclo; completare i target interessati in `07`, con file e revisione precisi.
3. Rivedere il target r10 di P13, il target r8 di P17, i target r7 di P04/P14/P16 e il fix P18; P19 è approvata, mentre P15 è approvata nella struttura visiva e conserva l'interazione r6 da validare.
...
| Asset visivi           | PARZIALE              | Confermare nome/logo provvisori o finali e la provenienza utilizzabile degli asset. Per RS 500, Laser Vago, RS Tera, J/80, First 25.7 e First 27 approvare un asset o un fallback neutro; le ricostruzioni del mock non vanno trattate come loghi ufficiali. |
...
- **Associazione barca:** in P15 verificare insieme i tre stati grigio/verde/blu. Selezione equipaggio senza barca → barca blu crea una sola associazione nella sessione aperta, aggiorna entrambi i riepiloghi e resta dopo reload; una barca non può appartenere a due equipaggi simultanei.
- **Ritorno ai Disponibili:** doppio click desktop e doppio tap touch su un membro liberano il solo slot e aggiornano pool/contatore; provare anche il comando esplicito equivalente con tastiera e tecnologia assistiva.
- **Comandate:** preview non mutante; quota base `floor(N/D)` uguale e resto assegnato ai “Giorni con più persone” scelti; capacità/somma e priorità rispettate; warning localizzati derivati dalla stessa fonte delle spiegazioni; ricalcolo preserva completati. In P13 l'assegnazione deve restare leggibile come azione rapida ma usare una card neutra con un segno `+` blu discreto, non un pulsante blu pieno; il bannerino istruttivo non va aggiunto; a 320 px il fallback conserva spazio al nome senza ridurre l'area attiva.
...
| U05 | RULE_HEAVY       | P04, modifica ed eliminazione                                                      | Profilo/Conoscenza coerenti, due note recenti e altre su richiesta, griglia settimanale condivisa con P18/P19, autosave, matrice referenze, invarianti, reviewer integrità/dominio.                                                                                                                      |
| U06 | FEATURE          | P05, Conoscenza                                                                    | Taglia diretta, note condivise, persistenza e dettatura integrata; self-review.                                                                                                                                                                                                                          |
| U07 | RULE_HEAVY       | P07 poi P08, Barche                                                                | Parser e duplicati, mapping tipi da `01`, identificativo logo/numero, stato “Da controllare” giallo distinto da “Disponibile”, Q01, storico; reviewer dominio.                                                                                                                                           |
...
| U10 | RULE_HEAVY       | P11 → P12 → P13, Comandate                                                         | Copertura assegnati/totale, card top-aligned, `floor`+resto, apertura diretta sul giorno, due allievi per riga con giorni brevi e azioni associate in card neutre (`+` blu discreto; fallback stretto che protegge il nome), nessun bannerino duplicativo, casi multi-giorno integri, icona warning vettoriale, completati e manual override; reviewer avversariale. |
| U11 | RULE_HEAVY       | P14 → P15 → P16, Equipaggi                                                         | Warning equipaggio/barca separati, doppio tap + comando accessibile verso Disponibili, popup e fascia con stati grigio/verde/blu e ordine numerico, associazione equipaggio→barca persistita, logo leggibile e tre campi in lettura, move/swap/copia, A terra/Mezzi/CT, invarianti; review dominio e UX. |
| U12 | FEATURE          | P17 → P18 → P19, Valutazioni                                                       | Nome e cinque icone SVG deselezionabili sulla stessa riga, nome come accesso alla nota, assenza vuota, colori, griglie condivise senza overflow, “Ordinamento” e righe nome da 40 px, riepilogo P19 in alto e soggetto sticky, note/storia/reload; self-review.                                          |
