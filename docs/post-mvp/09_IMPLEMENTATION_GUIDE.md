...
1. Applicare le decisioni umane consolidate fino al 5 settembre in `08` e `12`. Q01–Q13 sono risolte o superate per il design; restano nome/logo finale e tempi voce da misurare.
2. Approvare regole comuni e perimetro del ciclo; completare i target interessati in `07`, con file e revisione precisi.
3. Rivedere le rifiniture/interazioni P08/P13/P14/P15/P18 r6; P04 e P19 sono approvate, mentre P15 è approvata nella struttura visiva.
...
| U05 | RULE_HEAVY       | P04, modifica ed eliminazione                                                      | Profilo/Conoscenza coerenti, due note recenti e altre su richiesta, autosave, matrice referenze, invarianti, reviewer integrità/dominio.                                                                                                                                         |
...
| U10 | RULE_HEAVY       | P11 → P12 → P13, Comandate                                                         | Copertura assegnati/totale, card top-aligned, `floor`+resto, apertura diretta sul giorno, nomi in due colonne senza microcopy ripetuta, giorni/X separati, icona warning vettoriale, completati e manual override; reviewer avversariale.                                        |
| U11 | RULE_HEAVY       | P14 → P15 → P16, Equipaggi                                                         | Warning equipaggio/barca separati, doppio tap + comando accessibile verso Disponibili, fascia sticky senza overflow, stati grigio/verde/blu, associazione equipaggio→barca persistita, tre campi in lettura, move/swap/copia, A terra/Mezzi/CT, invarianti; review dominio e UX. |
| U12 | FEATURE          | P17 → P18 → P19, Valutazioni                                                       | Cinque valori deselezionabili, assenza vuota, colori, griglie senza overflow, “Ordinamento” con controlli da 40 px, riepilogo P19 in alto e soggetto sticky, note/storia/reload; self-review.                                                                                    |
