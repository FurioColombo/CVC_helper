...
| D1/Cabinato start at four per crew and allow manual changes; D2–D5 stay pairs through the 0.3.0 gate                  | Missing. Implement the four-person starting capacity and manual add/remove for D1/Cabinato. The D2–D5 Settings override is explicitly deferred to Claude Code after the gate. | C1 / deferred |
...
The owner lifted the `+`/`-` crew-card deferral on 2026-09-23 for D1/Cabinato
manual adjustment. On 2026-09-24, the owner deferred the D2–D5 Settings
override and its add/remove behavior to Claude Code after the 0.3.0 gate; it is
not a gate blocker. The two/three-name display choice remains in Settings and
is independent of crew capacity.
