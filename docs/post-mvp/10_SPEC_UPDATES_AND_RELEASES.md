...
Proposta: istruzione umana corrente → `01` comportamento/dominio → `02` perimetro approvato → `03` architettura → `09` ordine/prove. `06` e i target approvati di `07` guidano design e accettazione visuale senza contraddire le regole di prodotto. `05` conserva motivazioni e tracciabilità; `08` consolida Q01–Q09, mentre `12` contiene le sole Q10–Q13 ancora aperte al 5 settembre.
...
| §5.6/5.7 conoscenza e profilo         | Taglia/nota iniziale nello stesso form; altre note condizionali secondo Q13; stessa informazione persistita, scorciatoia e contratto salvataggio.                                       | STUD-01/02/03; Q09/Q13                |
...
| §7 Comandate                          | Copertura assegnati/totale, Ma/Me, preview non mutante, `floor(N/D)` + giorni extra confermati; warning su giorni/persone e selezione P13 secondo Q10.                                  | CMD-01–08; revisione r2/Q10           |
| §8.4 staff e enum                     | ADV/IS/CT, CT imbarcabile ed escluso da regole allievi; nome “Volontari disponibili”.                                                                                                   | VOL-01/03                             |
| §8.6/8.10/8.11 Equipaggi              | Header compatto; pool = mancanti; warning equipaggio distinto dalla barca; fascia barche Q11; contatore include A terra/esclude staff; annuncio in tre campi.                           | CREW-01–05; Q11                       |
| §9 Valutazioni                        | Nome sopra e cinque scelte sotto; secondo tap annulla; assenza vuota, colori e griglie senza scroll orizzontale; storia/riepilogo Q12.                                                  | EVAL-01–05; Q05 superata/Q12          |
...
| Condizionato                            | Regole Q01–Q09 recepite o superate. Restano Q10–Q13, verifica r3 sui viewport, trattamento grafico/nome finale e tempi voce misurati.                                                              |
