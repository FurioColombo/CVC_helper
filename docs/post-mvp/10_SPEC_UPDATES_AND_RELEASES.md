...
Proposta: istruzione umana corrente → `01` comportamento/dominio → `02` perimetro approvato → `03` architettura → `09` ordine/prove. `06` e i target approvati di `07` guidano design e accettazione visuale senza contraddire le regole di prodotto. `05` conserva motivazioni e tracciabilità; `08` consolida Q01–Q09 e `12` consolida Q10–Q13, rifinite fino al 6 settembre.
...
| §3/§4 creazione e Home                | Codice corso dinamico D/C + livello + settimana ISO + anno; simbolo CVC intero; sei card e nav Avarie/Home/Equipaggi, senza dashboard.                                                                                                                                                                                                 | BRAND-01/02; revisione r2             |
...
| §5.6/5.7 conoscenza e profilo         | Taglia/nota iniziale nello stesso form; due note recenti condizionali e altre su richiesta; griglia settimanale Valutazioni condivisa con P18/P19; stessa informazione persistita, scorciatoia e contratto salvataggio.                                                                                                                | STUD-01/02/03/09; Q09/Q13             |
...
| §6 configurazione barche              | Separatori multipli, vuoti ignorati e deduplicazione; preservare la mappatura normativa definita in `01`. I loghi aggiunti nel mock (RS 500, Laser Vago, RS Tera, J/80, First 25.7 e First 27) restano asset visivi da approvare e non cambiano da soli il dominio. | BOAT-01; revisione r2/r10             |
...
| §6/avarie                             | Identità barca comune, preview utile, stato diretto compatto; disponibilità e fault restano distinti. In P08 “Da controllare” è giallo e “Disponibile” neutro.                                                                                                                                                                         | BOAT-02, FAULT-01/02/04               |
| §7 Comandate                          | Copertura assegnati/totale, card top-aligned, Ma/Me, preview non mutante, `floor(N/D)` + giorni extra; P11 apre P13 sul giorno, poi assegnati/mai assegnati/altri giorni con due allievi per riga, nome azionabile in card neutra con `+` blu discreto (fallback stretto che protegge il nome), nessun bannerino duplicativo, giorni Lun–Dom, icona warning e X associata. | CMD-01–08; revisione r10/Q10          |
| §8.4 staff e enum                     | ADV/IS/CT, CT imbarcabile ed escluso da regole allievi; nome “Volontari disponibili”.                                                                                                                                                                                                                                                  | VOL-01/03                             |
| §8.6/8.10/8.11 Equipaggi              | Header compatto; pool = mancanti; warning equipaggio distinto dalla barca; doppio tap + comando esplicito verso Disponibili; popup P14 e fascia P15 condividono stati grigio/verde/blu e ordine numerico; associazione equipaggio→barca persistita; contatore include A terra/esclude staff; annuncio in tre campi con logo leggibile. | CREW-01–10; Q11                       |
| §9 Valutazioni                        | Nome e cinque icone SVG allineate sulla stessa riga; il nome apre la nota; secondo tap annulla; assenza vuota, colori e griglie senza scroll; P18 etichetta “Ordinamento” e righe nome da 40 px; in P19 riepilogo in alto, identità sticky e cronologia compatta.                                                                      | EVAL-01–08; revisione r8/Q12          |
| §5.4 scan / §11 voce                  | OCR: campi/persona, indicatori sticky live, fotocamera intera, rotazione/crop, niente cronometro manuale. Voce PC/Android/iPhone nel pannello testo, permesso al tap e collaudo autore.                                                                                                                                                | OCR-001/STT-001; Q06/Q07/revisione r2 |
...
| Condizionato                            | Regole Q01–Q13 recepite o superate. Restano approvazione del target r10 P13, dei target r7/r8 ancora aperti, trattamento grafico/nome finale e tempi voce misurati.                                 |
...
- Formalizzare autosave/errore e scritture coerenti dove necessario, controllo referenze al delete, CT additivo e compatibilità dati 0.1.0; transazioni coerenti per scollegamento CREW-06 e associazione CREW-08 nella sessione aperta.
...
- atomicità e unicità dell'associazione equipaggio–barca nella sessione, con aggiornamento coerente dei due lati e reload;
