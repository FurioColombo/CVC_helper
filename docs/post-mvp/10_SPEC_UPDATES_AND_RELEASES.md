...
Proposta: istruzione umana corrente → `01` comportamento/dominio → `02` perimetro approvato → `03` architettura → `09` ordine/prove. `06` e i target approvati di `07` guidano design e accettazione visuale senza contraddire le regole di prodotto. `05` conserva motivazioni e tracciabilità; `08` consolida Q01–Q09 e `12` consolida Q10–Q13, risolte il 5 settembre.
...
| §5.6/5.7 conoscenza e profilo         | Taglia/nota iniziale nello stesso form; due note recenti condizionali e altre su richiesta; stessa informazione persistita, scorciatoia e contratto salvataggio.                                                                                                                            | STUD-01/02/03; Q09/Q13                |
...
| §7 Comandate                          | Copertura assegnati/totale, card top-aligned, Ma/Me, preview non mutante, `floor(N/D)` + giorni extra; P11 apre P13 sul giorno, poi assegnati/mai assegnati/altri giorni su due colonne, con nome azionabile, giorni completi, icona warning e X separata.                                  | CMD-01–08; revisione r6/Q10           |
| §8.4 staff e enum                     | ADV/IS/CT, CT imbarcabile ed escluso da regole allievi; nome “Volontari disponibili”.                                                                                                                                                                                                       | VOL-01/03                             |
| §8.6/8.10/8.11 Equipaggi              | Header compatto; pool = mancanti; warning equipaggio distinto dalla barca; doppio tap + comando esplicito verso Disponibili; P15 sticky senza scroll con stati grigio/verde/blu e associazione equipaggio→barca persistita; contatore include A terra/esclude staff; annuncio in tre campi. | CREW-01–08; Q11                       |
| §9 Valutazioni                        | Nome sopra e cinque scelte sotto; secondo tap annulla; assenza vuota, colori e griglie senza scroll; P18 etichetta “Ordinamento” e controlli da 40 px; in P19 riepilogo in alto, identità sticky e cronologia compatta.                                                                     | EVAL-01–06; Q05 superata/Q12          |
...
| Condizionato                            | Regole Q01–Q13 recepite o superate. Restano approvazione r6 sui viewport, trattamento grafico/nome finale e tempi voce misurati.                                                                   |
